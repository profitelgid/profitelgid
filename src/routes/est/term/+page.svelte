...
<svelte:head>
    <title>Tingimused & Reeglid | PVCfactory</title>
    <meta name="description" content="Tutvu PVCfactory tingimuste ja reeglitega." />
</svelte:head>
			...
			<div class="product-img-box">
				<p class="product-image">
					<img
						...
						class="mainImage"
						style="height:350px"
						src="https://i.imgur.com/vc2btJP.png"
